...
```javascript
zeros = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-zeros@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-zeros@umd/bundle.js"></script>
```
